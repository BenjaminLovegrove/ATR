// Script for fading an object
// Will automatically fade all child objects as well
// Notes - object(s) should use the 'standard' shader (must have an alpha value)
// In the inspector drop down the shader options on the object(s) and set 'Rendering Mode' to 'Fade'
// The objects will always obey the fade time variable, regardless of when and how they're called
